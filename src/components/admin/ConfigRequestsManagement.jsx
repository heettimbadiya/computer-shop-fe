    ...
    <div className="space-y-6">
      ...
      <div className="card animate-slide-up">
        <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
          ...
          <div className="ml-auto flex items-center gap-2 px-5 py-2.5 bg-gradient-to-r from-primary-50 to-accent-50 rounded-xl border-2 border-primary-200 shadow-sm">
            <FileText className="w-4 h-4 text-primary-600" strokeWidth={2} />
              ...
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-4">
                    <span
                      className={`px-4 py-2 rounded-xl text-xs font-bold border-2 ${getStatusColor(
                        request.status
                ...
                <div className="flex flex-col gap-2 shrink-0">
                  <button
                    ...
                    className="btn-secondary text-sm whitespace-nowrap hover:shadow-md transition-all duration-200"
                  >
                  ...
                  {request.status !== 'completed' && (
                    <select
                      ...
                      className={`input-field text-sm cursor-pointer font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed ${
                  ...
                  {request.status === 'completed' && (
                    <div className="px-4 py-2.5 bg-gradient-to-r from-emerald-500 to-teal-500 text-white rounded-xl text-sm font-bold text-center shadow-md shadow-emerald-500/30 flex items-center justify-center gap-2">
        ...
        >
          ...
          >
            ...
            <div className="space-y-6">
              ...
              {/* Status Update */}
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-6 border-t-2 border-gray-200 bg-gradient-to-r from-gray-50/50 to-transparent -mx-6 px-6 pb-2 rounded-b-2xl">
                <div>
                ...
                <div className="flex items-center gap-3">
                  <select
                    ...
                    className={`input-field w-full sm:w-56 cursor-pointer font-semibold transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed ${
